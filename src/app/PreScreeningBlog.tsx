    ...
    <div className="min-h-screen bg-white font-sans text-[#5A5B5E] selection:bg-[#FF4500]/20 selection:text-[#C41E00]">
        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/10 shadow-sm mb-8">
              ...
              <span className="text-[11px] font-black tracking-widest text-white uppercase">Pre-Screening</span>
            </div>
            
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tight text-white leading-[1.1] mb-8">
              Pre-screening - Simpler Efforts, Better Results with <br className="hidden lg:block"/> <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4500] to-[#C41E00]">Asynchronous Video</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-6 pt-10 border-t border-white/10">
              ...
              <div>
                ...
                <div className="text-[14px] font-bold tracking-wide text-white uppercase">JUL 13, 2021</div>
              </div>
              <div className="hidden sm:block h-10 w-px bg-white/10 mx-2"></div>
              <div>
        ...
        <div className="mx-auto max-w-[1100px] px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-16">
          ...
          <article className="flex-1 max-w-3xl">
            ...
            <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-8">
              Pre-screening is the process of estimating the eligibility of a candidate for an available position at a business. While video calling has been around for a long time for this purpose, it has inherent limitations, especially when candidate numbers are high.
            </p>
            <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-8">
              A lot of time is wasted on coordinating and setting up meetings. Another issue arises when businesses want to pre-screen people from a different geographic location. It isn't easy to find common ground when it comes to timing.
            </p>
            ...
            <div className="my-16 p-10 bg-[#FAFAFA] rounded-3xl border border-[#5A5B5E]/5 relative overflow-hidden">
              ...
              <p className="relative z-10 text-xl font-bold text-[#1A1A1A] leading-relaxed italic text-center px-4">
                "It isn't easy to find common ground when it comes to timing in traditional interviews. Asynchronous changes the game entirely."
              </p>
            </div>
            ...
            {/* Sub-benefits formatted as beautiful blocks instead of just text */}
            <div className="space-y-12 mb-16">
              <div className="pl-6 border-l-4 border-[#FF4500]/30 hover:border-[#FF4500] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">1. Improved Credibility and Authenticity</h3>
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-4">
                ...
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7]">
                  Because asynchronous video is stored on a server (or locally) and can be played back later, it eliminates scheduling concerns with a candidate. But the advantage is that it still offers video as an interview medium without any of its drawbacks. And since it's compatible over several platforms and can be stored, you can review the videos anywhere, anytime, and on any device.
                </p>
              </div>

              <div className="pl-6 border-l-4 border-[#FF4500]/30 hover:border-[#FF4500] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">2. Can be Scaled Easily</h3>
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-4">
              ...
              <div className="pl-6 border-l-4 border-[#FF4500]/30 hover:border-[#FF4500] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">3. Saves Time, Effort and Cost</h3>
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-4">
              ...
              <div className="pl-6 border-l-4 border-[#FF4500]/30 hover:border-[#FF4500] transition-colors duration-300">
                <h3 className="text-xl font-bold text-[#1A1A1A] mb-3">4. Works as a Video Resume</h3>
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7] mb-4">
                  Getting noticed by employers is a challenge that job seekers face. Moreover, a resume is a one-dimensional document that cannot convey information other than their professional and academic achievements. This is why a lot of companies opt to hold video interviews for their candidates.
                </p>
                <p className="text-[17px] text-[#5A5B5E]/90 leading-[1.7]">
                  By using asynchronous video, candidates can add a new facet to their eligibility through video resumes. It is much more impactful than reading a text off a page and can give employers a unique perspective of potential candidates. As you can see, switching to asynchronous video can have several benefits for you both as a candidate or a business.
                </p>
              </div>
            </div>
      ...
      <section className="bg-[#111111] border-t border-white/10 relative overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10 relative z-10">
          ...
          {/* Previous */}
          <Link to="#" className="group relative p-12 sm:p-20 flex flex-col justify-center overflow-hidden transition-all duration-500">
